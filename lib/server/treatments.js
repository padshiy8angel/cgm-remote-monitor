...
function storage (env, ctx) {
  ...
  function upsert (obj, fn) {
    ...
    var foods = null;
    var gi_real = null;
    if (obj.preBolus && obj.boluscalc != null) {
      foods = obj.boluscalc.foods;
      if (obj.notes != null && obj.notes != '') {
        obj.notes += '\n';
      } else {
        obj.notes = '';
      }
      obj.notes += 'Пауза '  + obj.preBolus + ' мин';
      gi_real = obj.boluscalc.gi_real;
      delete obj.boluscalc.foods;
      delete obj.boluscalc.gi_real;
    }
    ...
    api( ).update(query, obj, {upsert: true}, function complete (err, updateResults) {
      ...
      if (!err && obj.preBolus) {
        ...
        pbTreat.boluscalc.foods = foods;
        pbTreat.boluscalc.gi_real = gi_real;
